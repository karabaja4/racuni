...
var PDF417 = {
	 ...
	 * @param aspectratio (float) the width to height of the symbol (excluding quiet zones); default 2
	 ...
	 * @param lineColor (string) color of the barcode lines https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/fillStyle
	*/
	draw: function(code, canvas, aspectratio, ecl, devicePixelRatio, lineColor) {
        ...
        var retinaMultiplier = devicePixelRatio ? devicePixelRatio : typeof window !== 'undefined' ? window.devicePixelRatio || 1 : 1
